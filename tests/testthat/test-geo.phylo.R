...
test_that("Are the returned values correct?", {
  ...
  pe.expect <- c(0.3807860, 0.3807860, 0.3807860, 0.4651102, 0.4776858, 0.4776858,
                 0.4776858, 0.4776858, 0.3805112, 0.3805112, 0.3496615, 0.3805112,
  ...
  pd.expect <- matrix(data = c(6.583520, 6.583520, 6.583520, 6.705980, 7.704928,
                               7.704928, 7.704928, 7.704928, 6.583520, 6.583520,
                               5.994505, 6.583520, 7.582468, 7.704928, 7.704928,
                               7.704928),
                      ncol = 1, byrow = F)
  ...
  ed.expect <- c(0.1530742, 0.1530742, 0.1530742, 0.1563603, 0.1735835,
                 0.1735835, 0.1735835, 0.1735835, 0.1530742, 0.1530742,
                 0.1371549, 0.1530742, 0.1702974, 0.1735835, 0.1735835, 0.1735835)
...
test_that("names are reordened in the function geo.phylo", {
  ...
  expect(geo.phylo(data$x, tree, #range.BL = area.branch$range.BL,
                   inv.R = inv.R, edge.path = data$edge.path[sample(1:nrow(data$edge.path)),],
                   branch.length = data$branch.length,
