test_that("check if function corrects names in branch", {
  ...
  require("SESraster")
  # tests
  expect_s4_class(rast.pe.ses(x, tree, aleats = 2, random = "spat"), "SpatRaster")
...
test_that("check if function corrects arguments with wrong names", {
  ...
  require("SESraster")
  # tests
  expect_s4_class(rast.pe.ses(x, tree, branch.length=branch.length, inv.R=inv.R, aleats = 2, random = "spat"), "SpatRaster")
  expect_s4_class(rast.pe(x, tree, branch.length=branch.length, inv.R=inv.R), "SpatRaster")
