...
test_that("check if function corrects arguments with wrong names", {
  ...
  require("SESraster")
  # tests
  expect_s4_class(geo.phylo.ses(ras, tree, inv.R=inv.R, branch.length=branch.length, n.descen=n.descen, aleats = 2), "SpatRaster")
  expect_s4_class(geo.phylo(ras, tree, inv.R=inv.R, branch.length=branch.length, n.descen=n.descen), "SpatRaster")
